...
class MIRA_BROWSER():
    def __init__(self, qt_self, browser_type: str):
        ...
        if self.browser_type == "bgt_reg_browser":
            ...
            filter = None
            file_path = "./radar_eval/measurement/hdf5/"
            direcotry = "./radar_eval/measurement/hdf5/"
            ...
            file_path = f"./radar_eval/measurement/hdf5/{MIRA_MEAS_PROJECT_NAME}.hdf5"
            direcotry = f"./radar_eval/measurement/hdf5/{MIRA_MEAS_PROJECT_NAME}.hdf5"
    ...
    def reinit(self, mira_project: str) -> None:
        ...
        if self.browser_type == "bgt_reg_browser":
            caption=f"Select BGT-Register for {self.radar_param.mon.sykno_product_name}"
            default_dir = f"./radar_eval/config/register_hex_files/" 
            filter = "Text Files (*.txt)"
            ...
            default_dir = f"{MIRA_MEASUREMENT_PATH}/{MIRA_MEAS_PROJECT_NAME}{mira_project}"
            filter = "Text Files (*.hdf5)"
            file_path = f"./radar_eval/measurement/hdf5/{mira_project}.hdf5"
            direcotry = f"./radar_eval/measurement/hdf5/{mira_project}.hdf5"
