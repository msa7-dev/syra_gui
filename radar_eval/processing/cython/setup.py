...
module_name = "radar_extract_raw_data"

# Path to the Cython file
cython_file = f"./radar_eval/processing/cython/{module_name}.pyx"
output_dir = "./radar_eval/processing/cython/"  
