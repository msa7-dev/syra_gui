...
class MIRA_USB_SPI_BRIDGE():
    ...
    def spi_activate_boot_mode(self, product_name: str='Sykno_Radar_Bridge_FW', firmware_name: str='') -> None:
        ...
        command = [
            ...
            '-e', 'all',
            # '-w', f'./radar_eval/setup/mcu_firmware/{firmware}.bin', '0x08000000',
        ...
        with subprocess.Popen(command, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True) as proc:
            try:
                ...
                for line in proc.stdout:
                    logger.info(line, end='')  # Print each line of stdout
                ...
                for line in proc.stderr:
                    logger.info(line, end='')  # Log or handle errors as needed
